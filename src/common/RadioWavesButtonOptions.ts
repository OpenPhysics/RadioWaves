...
export const LIGHT_SURFACE_TEXT_FILL = RadioWavesColors.controlSurfaceTextColorProperty;

/**
 * Combo-box chrome for panels. Item labels must use {@link LIGHT_SURFACE_TEXT_FILL}, not
 * {@link RadioWavesColors.textColorProperty} — that color is for labels on the dark panel fill.
 */
export const SIM_COMBO_BOX_OPTIONS = {
  buttonFill: RadioWavesColors.controlSurfaceColorProperty,
  listFill: RadioWavesColors.controlSurfaceColorProperty,
  buttonStroke: RadioWavesColors.panelBorderColorProperty,
  listStroke: RadioWavesColors.panelBorderColorProperty,
...
export const TIME_CONTROL_SPEED_RADIO_OPTIONS = {
  speedRadioButtonGroupOptions: {
    labelOptions: { fill: RadioWavesColors.textColorProperty },
  },
